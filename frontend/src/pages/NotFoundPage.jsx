...
export default function NotFoundPage() {
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center text-center">
      ...
      <p className="font-display text-5xl font-semibold tracking-tight text-[rgb(var(--fg))]">404</p>
      <p className="mt-2 text-[15px] font-medium text-[rgb(var(--fg))]">This page took a wrong turn</p>

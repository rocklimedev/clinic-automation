...
export default function PatientsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Patients" description="Manage patient visits and their feedback automation status" />
      ...
      <PatientDetailsDrawer patient={activePatient} open={!!activePatient} onClose={() => setActivePatient(null)} />
